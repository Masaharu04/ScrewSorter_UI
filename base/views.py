...
from send_data import SendSensorInfoRequest
...
addrList = [
    INPUT_ADDR,DISCRIMINATION_ADDR,RETURN_ADDR,ALIGNMENT_ADDR,MASTER_ADDR,OUTPUT_ADDR
]
...
class MainView:
    def __init__(self, master):
        ...
        self.send_sensor_info_request = SendSensorInfoRequest()
        ...
        self.MODULE_ADDRESSES = [INPUT_ADDR, DISCRIMINATION_ADDR, RETURN_ADDR, MASTER_ADDR, ALIGNMENT_ADDR,OUTPUT_ADDR]
        #接続確認応答フラグ
    ...
    def check_queue(self):
        try:
            ...
            self.send_sensor_info_request.sensor_info_request()
    ...
    def wait_for_responses(self, timeout=10):
        """ 応答を5秒間待機し、接続確認を行う """
    ...
    def create_amount_display(self, parent_frame):
        ...
        self.rate_label = ctk.CTkLabel(self.amount_frame, text="投入部ボルト残量", font=("Arial", 12), text_color="#cccccc")
