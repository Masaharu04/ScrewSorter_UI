...
from send_data import SendStockerTypeChange
...
class SettingViews:
    def __init__(self, master, on_close,callback_test, stocker_data_buf):
        ...
        self.send_stocker_type_change = SendStockerTypeChange()
    ...
    def _create_stocker_selection(self, parent):
        ...
        for i in range(3):
            self.selected_labels[i] = ctk.StringVar(value=stocker_labels[self.stocker_data_buf[i]])##################################
    ...
    def send_sirial(self):
       ...
       # print(self.selected_values)
        ...
        print(new_array)
        self.send_stocker_type_change.send_stocker_type_change(new_array)
