...
class SorenoidMenteView:
    ...
    def _create_sections(self, parent):
        ...
        self._sorenoid_A_section(sections_frame, "シャッター", 1, 2)
        self._sorenoid_B_section(sections_frame, "判別", 1, 3)
        self._sorenoid_C_section(sections_frame, "整列", 1, 4)
    ...
    def _sorenoid_A_section(self, parent, title, row, col):
        ...
        # 運転ボタン
        start_button = ctk.CTkButton(section_frame, text="運転", font=("Meiryo", 35, "bold"), command=lambda t=title: self.sore1(), width=200, height=50)
    ...
    def _sorenoid_B_section(self, parent, title, row, col):
        ...
        # 運転ボタン
        start_button = ctk.CTkButton(section_frame, text="運転", font=("Meiryo", 35, "bold"), command=lambda t=title: self.sore2(), width=200, height=50)
        start_button.pack(pady=(0, 15))
        # 運転ボタン
        start_button = ctk.CTkButton(section_frame, text="運転", font=("Meiryo", 35, "bold"), command=lambda t=title: self.sore3(), width=200, height=50)
        start_button.pack(pady=(0, 15))
        # 運転ボタン
        start_button = ctk.CTkButton(section_frame, text="運転", font=("Meiryo", 35, "bold"), command=lambda t=title: self.sore4(), width=200, height=50)
        start_button.pack(pady=(0, 15))
        # 運転ボタン
        start_button = ctk.CTkButton(section_frame, text="運転", font=("Meiryo", 35, "bold"), command=lambda t=title: self.sore5(), width=200, height=50)
        start_button.pack(pady=(0, 15))
        # 運転ボタン
        start_button = ctk.CTkButton(section_frame, text="運転", font=("Meiryo", 35, "bold"), command=lambda t=title: self.sore6(), width=200, height=50)
        start_button.pack(pady=(0, 15))
    ...
    def _sorenoid_C_section(self, parent, title, row, col):
        ...
        # 運転ボタン
        start_button = ctk.CTkButton(section_frame, text="運転", font=("Meiryo", 35, "bold"), command=lambda t=title: self.sore7(), width=200, height=50)
        start_button.pack(pady=(0, 15))

        # 運転ボタン
        start_button = ctk.CTkButton(section_frame, text="運転", font=("Meiryo", 35, "bold"), command=lambda t=title: self.sore8(), width=200, height=50)
        start_button.pack(pady=(0, 15))

        # 運転ボタン
        start_button = ctk.CTkButton(section_frame, text="運転", font=("Meiryo", 35, "bold"), command=lambda t=title: self.sore9(), width=200, height=50)
        start_button.pack(pady=(0, 15))
